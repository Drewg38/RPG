/* game.js (v3) — CSV-only Canvas RPG
   - No built-in scenarios; requires content.js to set window.RPG_CONTENT { pages, startId }.
   - Renders header image, paragraphs, and any number of choices (1..8).
   - Simple fight system when a page includes fight_* columns.
   - All strings use double quotes or template strings to avoid apostrophe parse issues.
*/
"use strict";
